...
<%@page	import="org.uta.sams.controller.UserController,org.uta.sams.beans.*"%><%@page
				...
				<div class="form-row">
					...
					<div class="col m-3">
						<label class="form-label" for="form3Example1">
							User ID:</label> <input type="text" name="name" class="form-control" />
					</div>
					...
					<div class="col m-3">
						<label class="form-label" for="form3Example1">
							Username/Email:</label> <input type="text" name="userName" class="form-control" />
					</div>
	...
	<div class="form-row">
		...
		<!-- Phone Number -->
				...
				<div class="form-row">
					...
					<div class="col m-3">
						<label class="form-label" for="form3Example1">
							Confirm PasswordAddress:</label> <input type="password" name="password" class="form-control" />
					</div>
               ...
               <!-- Access the data and Insert data in sql --@yxk-->
