  ...
  <div class="px-4 py-5 px-md-5 text-center text-lg-start" style="background-color: hsl(0, 0%, 96%) ">
      ...
      <div class="col gx-lg-5 align-items-center">
        <div class=" mb-5 mb-lg-0">
          <h1 class="my-5 display-3 fw-bold ls-tight" style="padding:100px 0 0 0">
            OFFICE OF<br />
          ...
          <div class="card">
            <div class="card-body py-5 px-md-5 ">
              <form action="<%= response.encodeURL("welcome.jsp") %>" method="post" onsubmit="return get_action();">
                  ...
                  <div class="mb-4">
                    <div class="form-outline">
                     <label class="form-label" for="form3Example2">Password</label>
                      ...
                      <!-- ReCAPTCHA -->     
                      <div class="g-recaptcha " style="padding: 10px 10px 0 0; width:500px; overflow-x:hidden " 
        data-sitekey="6LcKmmwlAAAAAGOWFh4IU7L3b6QuMEPwLRPHkIOD" required ></div>
        <br/>
        <!-- <input type='submit' value="Submit" > -->
          ...
          <script>
          	function get_action(form){
				...
				return false; //prevents from submission when reCaptcha is ivalid
