			...
			<main class="col mt-5 content">
				...
				<div class="row">
					...
					<div
						...
						<h1 class="h3 mb-0 text-gray-800">Settings Form</h1>
				...
				<div class="form-row">
					...
					<div class="col m-3">
						<label class="form-label" for="form3Example1">
							Settings Name:</label> <input type="text" name="name" class="form-control" />
					</div>
					...
					<div class="col m-3">
						<label class="form-label" for="form3Example1">
							Settings Option:</label> <input type="text" name="userName" class="form-control" />
					</div>
