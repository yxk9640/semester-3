...
<td style="border-right: 1px solid rgb(255, 255, 255);" bgcolor="#666666" height="92" valign="top" width="150">
 <script type="text/javascript" src="/jsp/commons/sams/fsmenu.js"></script>
              <jsp:include page="/jsp/commons/left.jsp"/>
            
 </td>
<td style="padding:100px 0 0 120px">
   ...
   <form name="uploadForm" action="change2()" enctype="multipart/form-data" method="post">    
       ...
       <tr>
           ...
           {%>
            ...
            <td><input type=text name="prg" value=""></td>
            <%
            }
            %>
...
{%>
    ...
    <input type=submit name='Upload' value='Upload' onclick="change2();">
