...
/*if(!(document.entry.RequestFor[0].checked))
{
  alert("Please Select for what you are requesting");
valid =false;
}*/
if(!((document.entry.InvitationLetterFor[0].checked)||(document.entry.InvitationLetterFor[1].checked)||(document.entry.InvitationLetterFor[2].checked)))
{
alert("Please Select the Reason you want the Invitation Letter For");
valid=false;
}
if(document.entry.InvitationLetterFor[2].checked)
{
if(document.entry.otherpi.value=="")
{
alert("Please enter the reason in the text box provided");
document.entry.otherpi.focus()
valid=false;
}
}
