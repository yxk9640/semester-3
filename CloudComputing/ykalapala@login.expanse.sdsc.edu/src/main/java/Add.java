...
//        Addition
        ...
        MultipleInputs.addInputPath(jobResult,new Path("left_tmp/part-r-00000"), SequenceFileInputFormat.class,AddMMapper.class);// seq
//        MultipleInputs.addInputPath(jobResult,new Path("left_tmp/part-r-00000"), TextInputFormat.class,AddMMapper.class);
        MultipleInputs.addInputPath(jobResult,new Path("right_tmp/part-r-00000"), SequenceFileInputFormat.class,AddNMapper.class);//seq
